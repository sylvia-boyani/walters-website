        ...
        <div className='container'>
          ...
          <div className='content flex'>
            <div className='left topMarign'>
              <Progress done='70' title='Content Writing' />
              <Progress done='80' title='Digital Branding' />
              <Progress done='90' title='Technical writing' />
              <Progress done='70' title='Digital Marketing' />
            </div>
